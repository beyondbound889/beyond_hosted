...
const testimonials = [
	{
		id: 'sarah',
		quote: '“My insulin levels have never been so balanced, totally recommend glycomics!! Worth every penny!!”',
		name: 'Naina Sharma',
	...
	{
		id: 'james',
		quote: '"The quality is exceptional. I appreciate the transparency in ingredients and the natural formulation. Highly recommended!"',
		name: 'James K.',
		role: 'Verified Customer',
		image: jamesImage,
	},
	{
		id: 'emily',
		quote: '"I\'ve tried many supplements, but Beyond Bound stands out. The results are noticeable and I love that it\'s all-natural."',
		name: 'Emily R.',
		role: 'Verified Customer',
		image: emilyImage,
	},
				...
				<div className="loved-frame">
					<header className="loved-header">
						...
						<div className="loved-heading-block">
							<h2 id="loved-title" className="loved-title">Loved by 10,000+</h2>
						...
						{testimonials.map((item) => (
							<article key={item.id} className="loved-card" role="listitem">
								...
								<div className="loved-profile">
									<img src={item.image} alt={item.name} className="loved-avatar" loading="lazy" decoding="async" />
