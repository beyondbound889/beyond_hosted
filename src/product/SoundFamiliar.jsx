    ...
    <div className="body-sf">
      <div className="container-sf">
        <header className="header-sf">
          ...
          <p className="subtitle-sf">
            Your Blood Sugar Is, Trying To Tell You Something.
          </p>
        </header>
        ...
        <footer className="footer-sf">
          <p>
            These aren't random feelings! they're your body's way of signalling
            that your glucose <br /> metabolism needs support. The good news?{" "}
            <strong>It's fixable.</strong>
          </p>
        </footer>
      </div>
    </div>
